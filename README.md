...
If the web datasets above don't match the semantics of your end use case, you can train word vectors on your own corpus.
    ...
    $ cd glove && make
    $ ./abstracts_trainer.sh

The abstracts_trainer.sh runs on specified text file defined on the ```CORPUS``` variable. It collects unigram counts, constructs and shuffles cooccurrence data, and trains a simple version of the GloVe model. It also runs a word analogy evaluation script in python to verify word vector quality. More details about training on your own corpus can be found by reading [src/README.md](https://github.com/stanfordnlp/GloVe/tree/master/src)
